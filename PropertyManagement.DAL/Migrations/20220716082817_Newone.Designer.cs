...
namespace PropertyManagement.DAL.Migrations
{
    ...
    [Migration("20220716082817_Newone")]
            ...
            modelBuilder.Entity("PropertyManagement.DAL.Model.PropertyAds", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ModifiedDate = new DateTime(2022, 7, 16, 13, 28, 16, 233, DateTimeKind.Local).AddTicks(1069),
                            PostDate = new DateTime(2022, 7, 16, 13, 28, 16, 233, DateTimeKind.Local).AddTicks(1506),
                            Price = 1000000m,
                            Quantity = 20,
                            SellerId = 2,
                        ...
                        new
                        {
                            ...
                            Images = "house.jfif",
                            Location = "SAN FRANCISCO, CA 55689",
                            ModifiedDate = new DateTime(2022, 7, 16, 13, 28, 16, 233, DateTimeKind.Local).AddTicks(2661),
                            PostDate = new DateTime(2022, 7, 16, 13, 28, 16, 233, DateTimeKind.Local).AddTicks(2673),
                            Price = 5000000m,
                            Quantity = 5,
                            SellerId = 2,
                        ...
                        new
                        {
                            ...
                            Images = "house.jfif",
                            Location = "SAN FRANCISCO, CA 55689",
                            ModifiedDate = new DateTime(2022, 7, 16, 13, 28, 16, 233, DateTimeKind.Local).AddTicks(2676),
                            PostDate = new DateTime(2022, 7, 16, 13, 28, 16, 233, DateTimeKind.Local).AddTicks(2678),
                            Price = 2000000m,
                            Quantity = 10,
                            SellerId = 2,
            ...
            modelBuilder.Entity("PropertyManagement.DAL.Model.PropertyChat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BuyerId = 1,
                            DateTime = new DateTime(2022, 7, 16, 13, 28, 16, 234, DateTimeKind.Local).AddTicks(1624),
                        ...
                        new
                        {
                            Id = 2,
                            BuyerId = 1,
                            DateTime = new DateTime(2022, 7, 16, 13, 28, 16, 234, DateTimeKind.Local).AddTicks(2423),
            ...
            modelBuilder.Entity("PropertyManagement.DAL.Model.PropertyFinder", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateTime = new DateTime(2022, 7, 16, 13, 28, 16, 233, DateTimeKind.Local).AddTicks(9156),
            ...
            modelBuilder.Entity("PropertyManagement.DAL.Model.PropertyReviews", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2022, 7, 16, 13, 28, 16, 234, DateTimeKind.Local).AddTicks(3555),
                            PropertyId = 1,
                            Rate = 4,
                        ...
                        {
                            Id = 2,
                            CreateAt = new DateTime(2022, 7, 16, 13, 28, 16, 234, DateTimeKind.Local).AddTicks(5594),
                            PropertyId = 2,
                            Rate = 5,
            ...
            modelBuilder.Entity("PropertyManagement.DAL.Model.PropertySale", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PropertyId = 1,
                            PurchaseDase = new DateTime(2022, 7, 16, 13, 28, 16, 233, DateTimeKind.Local).AddTicks(5051),
                            Qty = 1,
                            SellerId = 2,
                        ...
                        new
                        {
                            ...
                            PropertyId = 2,
                            PurchaseDase = new DateTime(2022, 7, 16, 13, 28, 16, 233, DateTimeKind.Local).AddTicks(6944),
                            Qty = 1,
                            SellerId = 2,
            ...
            modelBuilder.Entity("PropertyManagement.DAL.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateTime = new DateTime(2022, 7, 16, 13, 28, 16, 228, DateTimeKind.Local).AddTicks(2996),
                        ...
                        new
                        {
                            Id = 2,
                            Address = "This is test Address",
                            DateTime = new DateTime(2022, 7, 16, 13, 28, 16, 229, DateTimeKind.Local).AddTicks(4992),
                        ...
                        new
                        {
                            Id = 3,
                            Address = "This is test Address",
                            DateTime = new DateTime(2022, 7, 16, 13, 28, 16, 229, DateTimeKind.Local).AddTicks(5023),
