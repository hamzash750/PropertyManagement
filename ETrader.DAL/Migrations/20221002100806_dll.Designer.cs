            ...
            modelBuilder.Entity("ETrader.DAL.Model.PropertyAds", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ModifiedDate = new DateTime(2022, 10, 2, 15, 8, 5, 669, DateTimeKind.Local).AddTicks(3471),
                            Pool = false,
                            PostDate = new DateTime(2022, 10, 2, 15, 8, 5, 669, DateTimeKind.Local).AddTicks(4136),
                            Price = 1000000m,
                            Quantity = 20,
                            SellerId = 2,
                        ...
                        new
                        {
                            ...
                            Kitchen = 0,
                            Location = "SAN FRANCISCO, CA 55689",
                            ModifiedDate = new DateTime(2022, 10, 2, 15, 8, 5, 669, DateTimeKind.Local).AddTicks(5949),
                            Pool = false,
                            PostDate = new DateTime(2022, 10, 2, 15, 8, 5, 669, DateTimeKind.Local).AddTicks(5955),
                            Price = 5000000m,
                            Quantity = 5,
                            SellerId = 2,
                        ...
                        new
                        {
                            ...
                            Kitchen = 0,
                            Location = "SAN FRANCISCO, CA 55689",
                            ModifiedDate = new DateTime(2022, 10, 2, 15, 8, 5, 669, DateTimeKind.Local).AddTicks(5961),
                            Pool = false,
                            PostDate = new DateTime(2022, 10, 2, 15, 8, 5, 669, DateTimeKind.Local).AddTicks(5963),
                            Price = 2000000m,
                            Quantity = 10,
                            SellerId = 2,
            ...
            modelBuilder.Entity("ETrader.DAL.Model.PropertyChat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BuyerId = 1,
                            DateTime = new DateTime(2022, 10, 2, 15, 8, 5, 670, DateTimeKind.Local).AddTicks(9608),
                        ...
                        new
                        {
                            Id = 2,
                            BuyerId = 1,
                            DateTime = new DateTime(2022, 10, 2, 15, 8, 5, 671, DateTimeKind.Local).AddTicks(1048),
            ...
            modelBuilder.Entity("ETrader.DAL.Model.PropertyFinder", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateTime = new DateTime(2022, 10, 2, 15, 8, 5, 670, DateTimeKind.Local).AddTicks(5713),
            ...
            modelBuilder.Entity("ETrader.DAL.Model.PropertyReviews", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2022, 10, 2, 15, 8, 5, 671, DateTimeKind.Local).AddTicks(2785),
                            PropertyId = 1,
                            Rate = 4,
                        ...
                        {
                            Id = 2,
                            CreateAt = new DateTime(2022, 10, 2, 15, 8, 5, 671, DateTimeKind.Local).AddTicks(6446),
                            PropertyId = 2,
                            Rate = 5,
            ...
            modelBuilder.Entity("ETrader.DAL.Model.PropertySale", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PropertyId = 1,
                            PurchaseDase = new DateTime(2022, 10, 2, 15, 8, 5, 669, DateTimeKind.Local).AddTicks(9277),
                            Qty = 1,
                            SellerId = 2,
                        ...
                        new
                        {
                            ...
                            PropertyId = 2,
                            PurchaseDase = new DateTime(2022, 10, 2, 15, 8, 5, 670, DateTimeKind.Local).AddTicks(2270),
                            Qty = 1,
                            SellerId = 2,
            ...
            modelBuilder.Entity("ETrader.DAL.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateTime = new DateTime(2022, 10, 2, 15, 8, 5, 663, DateTimeKind.Local).AddTicks(4023),
                        ...
                        new
                        {
                            Id = 2,
                            Address = "This is test Address",
                            DateTime = new DateTime(2022, 10, 2, 15, 8, 5, 665, DateTimeKind.Local).AddTicks(9195),
                        ...
                        new
                        {
                            Id = 3,
                            Address = "This is test Address",
                            DateTime = new DateTime(2022, 10, 2, 15, 8, 5, 665, DateTimeKind.Local).AddTicks(9227),
