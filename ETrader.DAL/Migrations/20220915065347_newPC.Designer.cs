...
namespace ETrader.DAL.Migrations
{
    ...
    [Migration("20220915065347_newPC")]
    partial class newPC
    {
            ...
            modelBuilder.Entity("ETrader.DAL.Model.PropertyAds", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ModifiedDate = new DateTime(2022, 9, 15, 11, 53, 47, 268, DateTimeKind.Local).AddTicks(8252),
                            PostDate = new DateTime(2022, 9, 15, 11, 53, 47, 268, DateTimeKind.Local).AddTicks(8529),
                            Price = 1000000m,
                            Quantity = 20,
                            SellerId = 2,
                        ...
                        new
                        {
                            ...
                            Images = "house.jfif",
                            Location = "SAN FRANCISCO, CA 55689",
                            ModifiedDate = new DateTime(2022, 9, 15, 11, 53, 47, 268, DateTimeKind.Local).AddTicks(9242),
                            PostDate = new DateTime(2022, 9, 15, 11, 53, 47, 268, DateTimeKind.Local).AddTicks(9247),
                            Price = 5000000m,
                            Quantity = 5,
                            SellerId = 2,
                        ...
                        new
                        {
                            ...
                            Images = "house.jfif",
                            Location = "SAN FRANCISCO, CA 55689",
                            ModifiedDate = new DateTime(2022, 9, 15, 11, 53, 47, 268, DateTimeKind.Local).AddTicks(9250),
                            PostDate = new DateTime(2022, 9, 15, 11, 53, 47, 268, DateTimeKind.Local).AddTicks(9251),
                            Price = 2000000m,
                            Quantity = 10,
                            SellerId = 2,
            ...
            modelBuilder.Entity("ETrader.DAL.Model.PropertyChat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BuyerId = 1,
                            DateTime = new DateTime(2022, 9, 15, 11, 53, 47, 269, DateTimeKind.Local).AddTicks(6019),
                        ...
                        new
                        {
                            Id = 2,
                            BuyerId = 1,
                            DateTime = new DateTime(2022, 9, 15, 11, 53, 47, 269, DateTimeKind.Local).AddTicks(6634),
            ...
            modelBuilder.Entity("ETrader.DAL.Model.PropertyFinder", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateTime = new DateTime(2022, 9, 15, 11, 53, 47, 269, DateTimeKind.Local).AddTicks(3987),
            ...
            modelBuilder.Entity("ETrader.DAL.Model.PropertyReviews", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2022, 9, 15, 11, 53, 47, 269, DateTimeKind.Local).AddTicks(7545),
                            PropertyId = 1,
                            Rate = 4,
                        ...
                        {
                            Id = 2,
                            CreateAt = new DateTime(2022, 9, 15, 11, 53, 47, 269, DateTimeKind.Local).AddTicks(9190),
                            PropertyId = 2,
                            Rate = 5,
            ...
            modelBuilder.Entity("ETrader.DAL.Model.PropertySale", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PropertyId = 1,
                            PurchaseDase = new DateTime(2022, 9, 15, 11, 53, 47, 269, DateTimeKind.Local).AddTicks(919),
                            Qty = 1,
                            SellerId = 2,
                        ...
                        new
                        {
                            ...
                            PropertyId = 2,
                            PurchaseDase = new DateTime(2022, 9, 15, 11, 53, 47, 269, DateTimeKind.Local).AddTicks(2108),
                            Qty = 1,
                            SellerId = 2,
            ...
            modelBuilder.Entity("ETrader.DAL.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateTime = new DateTime(2022, 9, 15, 11, 53, 47, 265, DateTimeKind.Local).AddTicks(2900),
                        ...
                        new
                        {
                            Id = 2,
                            Address = "This is test Address",
                            DateTime = new DateTime(2022, 9, 15, 11, 53, 47, 266, DateTimeKind.Local).AddTicks(4174),
                        ...
                        new
                        {
                            Id = 3,
                            Address = "This is test Address",
                            DateTime = new DateTime(2022, 9, 15, 11, 53, 47, 266, DateTimeKind.Local).AddTicks(4217),
