...
namespace ETrader.DAL.Migrations
{
    ...
    [Migration("20221002080222_add sellerid")]
            ...
            modelBuilder.Entity("ETrader.DAL.Model.PropertyAds", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ModifiedDate = new DateTime(2022, 10, 2, 13, 2, 21, 134, DateTimeKind.Local).AddTicks(3132),
                            Pool = false,
                            PostDate = new DateTime(2022, 10, 2, 13, 2, 21, 134, DateTimeKind.Local).AddTicks(3659),
                            Price = 1000000m,
                            Quantity = 20,
                            SellerId = 2,
                        ...
                        new
                        {
                            ...
                            Kitchen = 0,
                            Location = "SAN FRANCISCO, CA 55689",
                            ModifiedDate = new DateTime(2022, 10, 2, 13, 2, 21, 134, DateTimeKind.Local).AddTicks(4769),
                            Pool = false,
                            PostDate = new DateTime(2022, 10, 2, 13, 2, 21, 134, DateTimeKind.Local).AddTicks(4779),
                            Price = 5000000m,
                            Quantity = 5,
                            SellerId = 2,
                        ...
                        new
                        {
                            ...
                            Kitchen = 0,
                            Location = "SAN FRANCISCO, CA 55689",
                            ModifiedDate = new DateTime(2022, 10, 2, 13, 2, 21, 134, DateTimeKind.Local).AddTicks(4782),
                            Pool = false,
                            PostDate = new DateTime(2022, 10, 2, 13, 2, 21, 134, DateTimeKind.Local).AddTicks(4783),
                            Price = 2000000m,
                            Quantity = 10,
                            SellerId = 2,
            ...
            modelBuilder.Entity("ETrader.DAL.Model.PropertyChat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BuyerId = 1,
                            DateTime = new DateTime(2022, 10, 2, 13, 2, 21, 135, DateTimeKind.Local).AddTicks(4363),
                        ...
                        new
                        {
                            Id = 2,
                            BuyerId = 1,
                            DateTime = new DateTime(2022, 10, 2, 13, 2, 21, 135, DateTimeKind.Local).AddTicks(5212),
            ...
            modelBuilder.Entity("ETrader.DAL.Model.PropertyFinder", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateTime = new DateTime(2022, 10, 2, 13, 2, 21, 135, DateTimeKind.Local).AddTicks(1539),
            ...
            modelBuilder.Entity("ETrader.DAL.Model.PropertyReviews", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2022, 10, 2, 13, 2, 21, 135, DateTimeKind.Local).AddTicks(6400),
                            PropertyId = 1,
                            Rate = 4,
                        ...
                        {
                            Id = 2,
                            CreateAt = new DateTime(2022, 10, 2, 13, 2, 21, 135, DateTimeKind.Local).AddTicks(8755),
                            PropertyId = 2,
                            Rate = 5,
            ...
            modelBuilder.Entity("ETrader.DAL.Model.PropertySale", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PropertyId = 1,
                            PurchaseDase = new DateTime(2022, 10, 2, 13, 2, 21, 134, DateTimeKind.Local).AddTicks(7072),
                            Qty = 1,
                            SellerId = 2,
                        ...
                        new
                        {
                            ...
                            PropertyId = 2,
                            PurchaseDase = new DateTime(2022, 10, 2, 13, 2, 21, 134, DateTimeKind.Local).AddTicks(8972),
                            Qty = 1,
                            SellerId = 2,
            ...
            modelBuilder.Entity("ETrader.DAL.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateTime = new DateTime(2022, 10, 2, 13, 2, 21, 129, DateTimeKind.Local).AddTicks(9812),
                        ...
                        new
                        {
                            Id = 2,
                            Address = "This is test Address",
                            DateTime = new DateTime(2022, 10, 2, 13, 2, 21, 131, DateTimeKind.Local).AddTicks(4761),
                        ...
                        new
                        {
                            Id = 3,
                            Address = "This is test Address",
                            DateTime = new DateTime(2022, 10, 2, 13, 2, 21, 131, DateTimeKind.Local).AddTicks(4793),
